...
./sent-segment.scala ../tokenization/shiji.tokenized.classical shiji.sent.classical
./sent-segment.scala ../tokenization/shiji.tokenized.modern shiji.sent.modern

echo 'Performing sentence alignment...'
echo > dict
hunalign -text -realign -utf -cautious -thresh=0 -autodict=dict \
    dict ./shiji.sent.classical ./shiji.sent.modern > shiji.sent.aligned || {
